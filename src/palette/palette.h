/*
 * palette.h: libpixmap palette module
 * (c)2010-2015 Seiji Nishimura
 * The original code was written by Chisato Yamauchi.
 * $Id: palette.h,v 1.1.1.4 2015/01/14 00:00:00 seiji Exp seiji $
 */
...
PALETTE_API int         palette_search_id  (const char *);
PALETTE_API const char *palette_search_name(int);
